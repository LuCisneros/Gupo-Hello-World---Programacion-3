...
public class DrinksActivity  extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            menu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    PopupMenu popupMenu = new PopupMenu(DrinksActivity.this, view);
                    ...
                    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                case R.id.nav_home: {
                                    Intent intent = new Intent(DrinksActivity.this, HogarActivity.class);
                                    startActivity(intent);
                                    break;
                                }
                                case R.id.nav_gallery: {
                                    Intent intent = new Intent(DrinksActivity.this, LacteosActivity.class);
                                    startActivity(intent);
                                    break;
                                }

                                case R.id.nav_slideshow: {
                                    Intent intent = new Intent(DrinksActivity.this, MeatActivity.class);
                                    startActivity(intent);
                                    break;
                                }
                                ...
                                case R.id.nav_dulces: {
                                    Intent intent = new Intent(DrinksActivity.this, CandyActivity.class);
                                    startActivity(intent);
                                    break;
                                }
                                case R.id.nav_otros: {
                                ...
                                case R.id.nav_configuracion: {
                                    Intent intent = new Intent(DrinksActivity.this, ConfigurationActivity.class);
                                    startActivity(intent);
                                    break;
                                }
                                case R.id.nav_carrito: {
                                    Intent intent = new Intent(DrinksActivity.this, CarritoDeComprasActivity.class);
                                    startActivity(intent);
                                    break;
                                }
